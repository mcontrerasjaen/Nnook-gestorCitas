      ...
      <div className="container mx-auto px-6 z-10 text-center">        
        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 text-gray-500 hover:text-[#D4AF37] transition-all group"
          >
            <User size={14} className="group-hover:scale-110 transition-transform" />
            <span className="text-[10px] uppercase tracking-[0.3em] font-black border-b border-transparent group-hover:border-[#D4AF37] pb-1">
              Acceso Clientes
            </span>
          </motion.button>
        </div>
